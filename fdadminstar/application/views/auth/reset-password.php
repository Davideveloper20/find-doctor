        ...
        <div class="row">
          <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
            ...
            <div class="card card-primary">
              <div class="card-header"><h4>Crear Nueva Contraseña</h4></div>
              <?php 
              ...
              <div class="card-body">
                ...
                <form method="POST" action="<?php echo base_url(); ?>index.php/Auth/Restablecer-Clave" class="needs-validation" novalidate="">
                    <input id="csrf-token" type="password" class="form-control sr-only hidden" value="<?php echo $key; ?>" name="csrf-token" tabindex="1" required>
                  <div class="form-group">
                    <label for="password">Contraseña</label>
                    <input id="password" type="password" class="form-control" name="password" tabindex="1" required autofocus placeholder="Escriba una nueva contraseña">

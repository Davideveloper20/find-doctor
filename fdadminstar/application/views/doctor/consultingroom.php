        ...
        <div class="container-fluid">
          <div class="form-group mb-0 d-flex justify-content-between">
            ...
            <div class="section-header-breadcrumb d-flex my-auto">
              ...
              <div class="breadcrumb-item">Mis Consultorios</div>
            </div>
          </div>
          <div class="section-body mt-3">
            <p class="section-lead">Mis Consultorios.<a href="#modalDocEduc" data-toggle="modal" class="btn btn-success btn-sm pull-right"><i class="fa fa-plus fa-fw"></i><span class="hidden-xs"><?php echo trans('add'); ?></span></a></p>
            <div class="row">
